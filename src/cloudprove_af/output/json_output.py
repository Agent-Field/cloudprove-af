"""JSON output formatter for CloudProve-AF."""
...
def generate_json(result: CloudProveScanResult, pretty: bool = True) -> str:
...
def generate_summary_json(result: CloudProveScanResult) -> str:
...
def render_json(result: CloudProveScanResult) -> dict[str, object]:
