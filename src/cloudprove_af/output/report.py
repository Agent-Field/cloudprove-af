"""Markdown report generator for CloudProve-AF."""
...
def generate_report(result: CloudProveScanResult) -> str:
    """Generate a Markdown report from a CloudProve scan result."""
    lines: list[str] = [
        "# CloudProve-AF Infrastructure Security Report",
        "",
...
def render_report(result: CloudProveScanResult) -> str:
...
def _render_summary(result: CloudProveScanResult) -> list[str]:
    return [
        "## Summary",
        "",
