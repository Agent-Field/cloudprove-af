...
def _resolve_repo(repo_url: str) -> str:
    ...
    return str(Path(os.getenv("CLOUDPROVE_REPO_PATH", os.getcwd())).resolve())
...
async def _run_pipeline(scan_input: CloudProveInput) -> dict[str, object]:
    ...
    orchestrator.checkpoint_dir = orchestrator.repo_path / ".cloudprove"
