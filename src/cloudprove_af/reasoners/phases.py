...
from cloudprove_af.config import DEPTH_CHAIN_LIMITS, DEPTH_HUNTER_MAP, DEPTH_PROVER_CAPS, DepthProfile
from cloudprove_af.schemas.chain import ChainResult
from cloudprove_af.schemas.hunt import HuntResult, RawFinding
from cloudprove_af.schemas.prove import RemediationSuggestion, Verdict, VerifiedFinding
...
NODE_ID = os.getenv("NODE_ID", "cloudprove")
...
def _fallback_verified(finding: RawFinding, error_msg: str) -> VerifiedFinding:
    from cloudprove_af.schemas.prove import Proof, ProofMethod
    ...
    return VerifiedFinding(
        ...
        sarif_rule_id=f"cloudprove/{finding.hunter_strategy}/{finding.category}",
