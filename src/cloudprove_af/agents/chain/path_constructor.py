...
from cloudprove_af.schemas.chain import AttackPath, ChainResult
from cloudprove_af.schemas.hunt import RawFinding
from cloudprove_af.schemas.recon import DriftReport, ResourceGraph
...
async def run_path_constructor(
    ...
    harness_cwd = tempfile.mkdtemp(prefix="cloudprove-chain-")
    try:
