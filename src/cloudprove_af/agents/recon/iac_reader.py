...
from cloudprove_af.agents.recon._terraform_parser import parse_terraform_directory
from cloudprove_af.schemas.recon import ResourceInventory
...
async def run_iac_reader(app: HarnessCapable, repo_path: str) -> ResourceInventory:
    work_dir = tempfile.mkdtemp(prefix="cloudprove-recon-iac-reader-")
    try:
