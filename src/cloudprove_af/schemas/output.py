"""Output and orchestration schemas for CloudProve-AF.
...
class CloudProveScanResult(BaseModel):
    """Top-level CloudProve scan output."""
...
_ = CloudProveScanResult.model_rebuild()
