...
async def main():
    parser = argparse.ArgumentParser(description="CloudProve-AF Trigger")
    ...
    async with httpx.AsyncClient(timeout=600.0) as client:
        try:
            response = await client.post("http://localhost:8081/api/v1/execute/async/cloudprove.scan", json=payload)
